...
#define LOG_TAG "android.hardware.light@2.0-service.xiaomi_vince"
...
static void handleVinceNotification(const LightState& state) {
...
static std::map<Type, std::function<void(const LightState&)>> lights = {
    {Type::BACKLIGHT, handleVinceBacklight},
    {Type::NOTIFICATIONS, handleVinceNotification},
    {Type::BATTERY, handleVinceNotification},
    {Type::ATTENTION, handleVinceNotification},
};
